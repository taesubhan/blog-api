...
A full-stack blogging platform built with **React.js**, **Express.js**, and **PostgreSQL**.  
Users can **create, read, update, and delete blog posts**, with **JWT-based authentication** to protect private routes and ensure secure content management.

Link: https://taesh-blog.netlify.app/
...
- PostgreSQL integration for structured, relational data management
